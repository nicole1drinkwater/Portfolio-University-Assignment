...
function generateWeather() {
    ...
    for (var i = 0; i < days.length; i++) {
        ...
        document.getElementById("5DayWeather").innerHTML
            ...
            tempToday + " degrees Fahrenheit.</div>";
    }
}
...
function openTheStand() {
    ...
    dislplayResults(numGlasses, glassPrice, totalGlasses);
}



// calculates results and displays a report
function dislplayResults(weeklyInventory, glassPrice, weeklySales) {
    // calculate results
    ...
    document.getElementById("result").innerHTML +=
        "<p>You sold a total of " + weeklySales + " glasses of lemonade this week.</p > ";
    document.getElementById("result").innerHTML +=
